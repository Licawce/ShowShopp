...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-showsystem-secret-key-change-in-production-2024')

DEBUG = True  # Временно устанавливаем True для отладки
